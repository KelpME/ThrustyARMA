...
static const std::map<std::pair<int, InputType>, SlotLabel> SLOT_LABELS = {
    ...
    {{BTN_EAST, InputType::KEY}, {"B", "B (East)"}},
    {{BTN_NORTH, InputType::KEY}, {"X", "X (Left)"}},
    {{BTN_WEST, InputType::KEY}, {"Y", "Y (Top)"}},
    {{BTN_TL, InputType::KEY}, {"L Shoulder", "Left Shoulder"}},
    {{BTN_TR, InputType::KEY}, {"R Shoulder", "Right Shoulder"}},
    {{BTN_TL2, InputType::KEY}, {"L Trigger", "Left Trigger Click"}},
    {{BTN_TR2, InputType::KEY}, {"R Trigger", "Right Trigger Click"}},
    {{BTN_SELECT, InputType::KEY}, {"Select", "Select"}},
    {{BTN_DPAD_UP, InputType::KEY}, {"DPad Up", "D-Pad Up"}},
    {{BTN_DPAD_DOWN, InputType::KEY}, {"DPad Down", "D-Pad Down"}},
    {{BTN_DPAD_LEFT, InputType::KEY}, {"DPad Left", "D-Pad Left"}},
    {{BTN_DPAD_RIGHT, InputType::KEY}, {"DPad Right", "D-Pad Right"}},
